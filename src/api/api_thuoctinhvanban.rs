...
use sqlx::{MySql, Pool};
use serde_json::json;
use crate::db::admin_article::{GET_TYPE_DOCUMENTS_SQL, GET_ORGANIZATION_SQL, GET_FIELD_SQL};
use crate::models::document::{convert_type_documents, TypeDocument, convert_organization, Organization, convert_field, Field};

#[get("/api/thuoctinhvanban")]
pub async fn get_thuoctinhvanban_json(db_pool: web::Data<Pool<MySql>>) -> impl Responder {
